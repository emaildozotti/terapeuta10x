...
const App: React.FC = () => {
  return (
    <>
      <main
        className="relative min-h-[100dvh] lg:h-[100dvh] w-full flex flex-col items-center overflow-hidden"
      ...
      >
        ...
        {/* ── BARRA DE EVENTO ── */}
        <div
          className="relative z-10 w-full flex-shrink-0 flex items-center justify-center gap-3 py-3 px-4"
          style={{
        ...
        {/* ── HERO BLOCK ── */}
        <div className="relative z-10 flex flex-col items-center text-center px-6 pt-10 pb-12 w-full max-w-[512px] lg:flex-row lg:items-center lg:text-left lg:max-w-5xl lg:px-16 lg:py-0 lg:gap-20 lg:flex-1">

          {/* ── COLUNA ESQUERDA (desktop) / bloco único (mobile) ── */}
          <div className="flex flex-col items-center text-center w-full lg:items-start lg:text-left lg:w-1/2 lg:flex-shrink-0">

            {/* HEADLINE */}
            <div className="flex flex-col items-center gap-0 mb-6 lg:items-start">
              <span
          ...
          {/* ── COLUNA DIREITA (desktop) / continuação (mobile) ── */}
          <div className="flex flex-col items-center w-full lg:items-start lg:w-1/2">
            ...
            {/* PRICE ANCHOR */}
            <div className="flex flex-col items-center gap-1 mb-5 w-full lg:items-start">
              <span
                className="font-sans"
                style={{
                  fontSize: '0.85rem',
            ...
            {/* FOOTER */}
            <p
              className="font-sans mt-6 w-full text-center lg:text-left"
              style={{
                fontSize: '11px',
